...
\include{capitulos/4_Idealização do Aplicativo}  % Texto do cap4.tex
\include{capitulos/5_resultados} % Texto do cap5.tex
\include{capitulos/6_conclusoes} % Texto do cap6.tex
\include{capitulos/7_Trabalhos Correlatos} % Texto do cap7.tex
